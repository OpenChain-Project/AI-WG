*Draft Document from the OpenChain Project AI Work Group*
...
[2. Terms and Definitions 5](#terms-and-definitions)

> [2.1 Artificial Intelligence (AI)\
> a computer system capable of performing tasks that would previously require human intelligence 5](#artificial-intelligence-ai-a-computer-system-capable-of-performing-tasks-that-would-previously-require-human-intelligence)
>
> [2.2 Artificial Intelligence System Bill of Materials (AI SBOM)\
> a list of components and relevant information about the components that make up part or all of an AI system 5](#artificial-intelligence-system-bill-of-materials-ai-sbom-a-list-of-components-and-relevant-information-about-the-components-that-make-up-part-or-all-of-an-ai-system)
>
> [2.3 Artificial Intelligence System Bill of Materials Compliance (AI SBOM Compliance)\
> a compliance activity related to AI that uses a bill of materials to support licensing, regulatory or business requirements 5](#artificial-intelligence-system-bill-of-materials-compliance-ai-sbom-compliance-a-compliance-activity-related-to-ai-that-uses-a-bill-of-materials-to-support-licensing-regulatory-or-business-requirements)
>
> [2.4 - compliance artifacts 5](#compliance-artifacts)
>
> [2.5 - identified licenses 5](#identified-licenses)
>
> [2.6 - program 5](#program)
>
> [2.7 - program participants 6](#program-participants)
>
> [2.8 - supplied software 6](#supplied-software)
>
> [2.9 - verification materials 6](#verification-materials)

[3. Guidance 7](#guidance)

> [3.1 Policy 7](#policy)
>
> [Verification materials: 7](#verification-materials-1)
>
> [Rationale: 7](#rationale)
>
> [3.2 Competence 7](#competence)
>
> [Verification material(s): 8](#verification-materials-2)
>
> [Rationale: 8](#rationale-1)
>
> [3.3 Awareness 8](#awareness)
>
> [Verification material(s): 9](#verification-materials-3)
>
> [Rationale: 9](#rationale-2)
>
> [3.4 Program scope 9](#program-scope)
>
> [Verification material(s): 9](#verification-materials-4)
>
> [Rationale: 9](#rationale-3)
>
> [3.5 License obligations 10](#license-obligations)
>
> [Verification material(s): 10](#verification-materials-5)
>
> [Rationale: 10](#rationale-4)
>
> [3.6 Transparency obligations 10](#transparency-obligations)
>
> [Verification material(s): 11](#verification-materials-6)
>
> [Rationale: 11](#rationale-5)
>
> [3.7 Access 11](#access)
>
> [Verification material(s): 11](#verification-materials-7)
>
> [Rationale: 11](#rationale-6)
>
> [3.8 Effectively resourced 11](#effectively-resourced)
>
> [Verification material(s): 12](#verification-materials-8)
>
> [Rationale: 12](#rationale-7)
>
> [3.9 AI content review and approval 13](#_heading=h.mq0qne9ooc4p)
>
> [Verification material(s): 13](#_heading=h.fox0oq5akkjv)
>
> [Rationale: 13](#_heading=h.em31dddecnrc)
>
> [3.10 AI System Bill of Materials 13](#ai-system-bill-of-materials)
>
> [Verification material(s): 13](#verification-materials-9)
>
> [Rationale: 13](#rationale-8)
>
> [3.11 Governance 14](#governance)
>
> [Verification material(s): 14](#verification-materials-10)
>
> [Rationale: 14](#rationale-9)
...
-   ISO/IEC 5230:2020 [^1] *[https://www.iso.org/standard/81039.html](https://www.iso.org/standard/81039.html)*

-   ISO/IEC 42001:2023 *[https://www.iso.org/standard/81230.html](https://www.iso.org/standard/81230.html)*

-   ISO/IEC 5962:2021 [^2] *[https://www.iso.org/standard/81870.html](https://www.iso.org/standard/81870.html)*
...
>
> These definitions are originally from IETF RFC 2119: [https://www.ietf.org/rfc/rfc2119.txt](https://www.ietf.org/rfc/rfc2119.txt) The OpenChain Project Specification Work Group reviewed the ISO definitions in 2023 to confirm no conflict: [https://www.iso.org/foreword-supplementary-information.html](https://www.iso.org/foreword-supplementary-information.html)
...
-   Determine the necessary competence of program participants fulfilling each role. Program participants must have the requisite skills, knowledge, experience, and engagement with the functions below if relevant to the use case: [^5]
...
[^1]: OpenChain Project version: [OpenChain ISO/IEC 5230 - License Compliance](https://openchainproject.org/license-compliance) is functionally identical and freely available

[^2]: SPDX Project version:\
    [https://spdx.dev/wp-content/uploads/sites/31/2023/09/SPDX-specification-2-2.pdf](https://spdx.dev/wp-content/uploads/sites/31/2023/09/SPDX-specification-2-2.pdf) is functionally identical and freely available
